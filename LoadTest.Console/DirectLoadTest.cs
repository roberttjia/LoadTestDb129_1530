...
namespace LoadTest.Console
{
    public class DirectLoadTest
    {
        ...
        {
            System.Console.WriteLine("Starting Direct Load Test for LoadTestDb129_1530...");
            System.Console.WriteLine("This will populate all 129 entities with test data");
            ...
            try
            {
                ...
                // Run the load test
                var recordsPerEntity = 30; // Smaller number for faster testing with 129 entities
        ...
        {
            System.Console.WriteLine("Verifying created data for all 129 entities...");
            ...
            System.Console.WriteLine($"Total records created across 129 entities: {totalRecords}");
        }
